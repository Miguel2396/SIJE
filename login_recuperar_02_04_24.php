...
.posted-by
{
	...
	<script>
		...
		$(document).ready(function(){
			...
			if (prodId == '2'){
				$("#Novedad").html('<img src="../../kimages/alert.png" align="absmiddle"/><b>...Usuario y/o correo no valido</b>');
			}	
...
<body>
         ...
         <div class="col-md-12">
            ...
            <div class="wrap">
                ...
                <form class="login" action='../controller/recuperar_acceso' method="post" enctype="application/x-www-form-urlencoded"   accept-charset="UTF-8">
					 	...
					 	<div class="remember-sup">
						  <h4 style="color: aliceblue">Bienvenido al portal<br>
							 ...
							 <input class="form-control" type="text" placeholder="Correo Electrónico" required   name="datocorreo" />
							 <input class="form-control" type="text" placeholder="Cedula de Identidad"  required name="datocedula" />
					
							<input name="dato_sx" type="hidden" id="dato_sx" value="register">
                
							<input type="submit" value="Recuperar clave de acceso" class="btn btn-primary btn-lg" />
                			...
                			<div class="remember-forgot">
								...
								<div class="container-fluid">
								  <div class="row" style="padding-bottom: 10px;padding-top: 10px">
									...
									<div class="col-sm-12" style="padding-bottom: 10px;padding-top: 80px">
